...
def print_instruction():
    print("[ and ]: Cycle through views of the game from the perspective of each player in turn (single player view)")
    print("A: Switch to the 'all' view that shows all planets, regardless of ownership")
    print("L: Cycle through the different planet attribute types to show, including ID, number of ships, vision age, owner ID, growth rate, and vision range")
    print("R: Reset the screen to its original size and position")
    print("N: Update the game state by one tick")
    print("P: Toggle pause mode on and off")
    print("+ or =: Speed up the simulation by 5 updates per second")
    print("-: Slow down the simulation by 5 updates per second")
